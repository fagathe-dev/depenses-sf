...
#[UniqueEntity('email', message: 'This email is already taken by another user.', errorPath: 'email')]
#[UniqueEntity('username', message: 'This username is already taken by another user.', errorPath: 'username')]
